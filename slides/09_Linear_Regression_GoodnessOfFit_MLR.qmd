...
ggplot(df2, aes(x = x, y = y)) +
  ...
  # SST segment: yi to y-bar
  geom_segment(data = df2[i0,],
               aes(x=x, xend=x, y=ymn, yend=y),
               color = iscal_burgundy, linewidth = 1.5,
               arrow = arrow(length=unit(0.2,"cm"), ends="both")) +
  # SSE segment: y-bar to y-hat
  geom_segment(data = df2[i0,],
               aes(x=x+1.2, xend=x+1.2, y=ymn, yend=yhat),
               color = iscal_blue, linewidth = 1.5,
               arrow = arrow(length=unit(0.2,"cm"), ends="both")) +
  # SSR segment: y-hat to y
  geom_segment(data = df2[i0,],
               aes(x=x-1.2, xend=x-1.2, y=yhat, yend=y),
               color = iscal_dark_burgundy, linewidth = 1.5,
               arrow = arrow(length=unit(0.2,"cm"), ends="both")) +
  annotate("text", x=x2[i0]+3.5, y=(y2[i0]+ymn)/2,
           label="SST", color=iscal_burgundy, size=4.5, fontface="bold") +
  annotate("text", x=x2[i0]+5.5, y=(yh2[i0]+ymn)/2,
           label="SSE", color=iscal_blue, size=4.5, fontface="bold") +
  annotate("text", x=x2[i0]-5, y=(y2[i0]+yh2[i0])/2,
