...
```{r resid-fitted, echo=FALSE, fig.height=4.0, fig.width=10}
df_diag <- data.frame(
...
```{r qq-plot, echo=FALSE, fig.height=4.0, fig.width=9}
...
```{r scale-loc, echo=FALSE, fig.height=3.5, fig.width=5.5}
df_sl <- data.frame(
  fitted = fitted(mlr_model),
...
:::
::: {.column width="50%"}
**Ideal:** the smooth line is **roughly horizontal** (constant spread).
