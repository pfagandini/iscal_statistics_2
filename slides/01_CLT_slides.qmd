...
ggplot() +
  geom_ribbon(data = shade25, aes(x = x, ymin = 0, ymax = y), fill = "#8B1538", alpha = 0.85) +
  geom_ribbon(data = shade81, aes(x = x, ymin = 0, ymax = y), fill = "#8B1538", alpha = 0.25) +
...
ggplot() +
  geom_ribbon(data = shade81b,  aes(x = x, ymin = 0, ymax = y), fill = "#8B1538", alpha = 0.85) +
  geom_ribbon(data = shade225,  aes(x = x, ymin = 0, ymax = y), fill = "#8B1538", alpha = 0.25) +
